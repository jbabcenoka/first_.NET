...
{
    [Serializable]
    public class Implementation1 : IOrderManager
    {
        ...
        public void CreateTestData()
        {
            ...
            pasutijums.PasutijumaDetalas = DetalasList;
            ...
            pasutijums2.PasutijumaDetalas = DetalasList2;
            ...
            pasutijums3.PasutijumaDetalas = DetalasList3;
        ...
        public string Print()
        {
            ...
            foreach (var pasutijums in allOrders)
            {
                ...
                s += "\n \n       Pasutijuma produkti:";
                foreach (OrderDetail i in pasutijums.PasutijumaDetalas)
                {

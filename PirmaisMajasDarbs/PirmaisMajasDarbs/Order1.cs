...
namespace Order1
{
    ...
    public class Order : Product
    {
        ...
        public void addProduct(string name, decimal price, int Amount)
        {
            ...
            if(PasutijumaDetalas !=null ) PasutijumaDetalas.Add(Details);   //pievienojam pie visām pasūtījuma detaļām jauno pasūtījumu detaļu
            else
            {
                throw new System.ArgumentException("Vēl nav izveidots saraksts!!!!");
            }
         }
        public List<OrderDetail> PasutijumaDetalas { get; set; }  //visas pasūtījuma detaļas ar produktiem
